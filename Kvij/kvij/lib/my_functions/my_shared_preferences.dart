...
class MySharedPreferences {
  ...
  static Future<bool> saveSharedPreferenceUserName(String userName) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    return sharedPreferences.setString("user name", userName);
  }
  ...
  static Future<String?> getSharedPreferenceUserName() async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
